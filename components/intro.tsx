    ...
    <section ref={ref} id='home' className='relative lg:mt-[-2rem] flex flex-col items-center lg:flex-row lg:items-center lg:justify-center lg:h-screen space-x-0 lg:space-x-8 scroll-mt-[100rem]'>
      ...
      >
        ...
        <div className='flex mt-6 space-x-6 lg:space-x-10 justify-center lg:pl-10 pt-6'>
          <Link href='/Ruwini_Tharanga_CV.pdf' download={true} target='_blank' className='bg-[#D45A5A] hover:bg-[#D93D3D] w-36 text-white font-medium text-sm py-2 rounded-full flex justify-center items-center outline-none hover:scale-110 active:scale-105'>MY RESUME</Link>
